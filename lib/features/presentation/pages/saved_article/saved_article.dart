    ...
    return AppBar(
      leading: Builder(
        builder: (context) => GestureDetector(
          ...
          child: const Icon(Ionicons.chevron_back,color: Colors.black87,),
        ),
      ),
      title: const Text('Saved Articles',style: TextStyle(color:Colors.black87),),
    );
  }
  Widget _buildBody(){
    ...
    return ListView.builder(
      ...
      itemBuilder: (context,index){
        return ArticleWidget(
          ...
          isRemovable:true,
          onReomve:(article)=> _onRemoveArticle(context,article),
